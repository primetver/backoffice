...
from pplan.datautils import today, months
from .models import (MonthBookingSummary, MonthBookingEmployee, ProjectBooking)
from pplan.models import Employee
...
class MonthBookingAdmin(BaseBookingAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        month_list = [month_from + monthdelta(i)
...
class MonthBookingEmployeeAdmin(BaseBookingAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        sub_list = [employee.id for employee in current_employee.subordinates(
        ...
        response.context_data['summary'], response.context_data['total'] = qs.get_booking(
            month_list, employee_id)
